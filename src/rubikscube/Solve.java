...
public class Solve {
    ...
    /**
     * Create a Rubik's Cube from a file description.
     * Assumes file is valid and formatted as expected.
     */
    ...
    public void makeMove(char c) {
        ...
        else throw new IllegalArgumentException("Incorrect move: " + c);
    }
    ...
    /**
     * Order of a move sequence (how many times you must apply it to return to solved).
     */
    ...
    /**
     * Solve the cube with iterative deepening DFS up to maxDepth.
     * Returns the move sequence or null if not found within depth.
     */
    ...
    public static void main(String[] args) {
        ...
        // Try to solve with depth up to 7
        String solution = cube.solve(7);

        if (solution == null) {
            System.out.println("No solution found within depth 7");
        } else {
